...
description: "Systematic debugging — activate when user asks to debug, investigate errors, or find root cause"
---
...
Standalone command. After investigating, run `/sl-review` and `/sl-ship` if you made code changes, or start fresh with `/sl-plan` if the investigation revealed a bigger problem.
