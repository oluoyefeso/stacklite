---
mode: "agent"
description: "OWASP Top 10 and STRIDE security audit"
---
...
## Arguments
- `/sl-secure` — full audit (8/10 confidence gate, zero noise)
- `/sl-secure --comprehensive` — deep scan (2/10 bar, surfaces more, marks low-confidence as TENTATIVE)
- `/sl-secure --diff` — branch changes only (combinable with above)
