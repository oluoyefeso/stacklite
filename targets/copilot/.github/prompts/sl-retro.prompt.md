---
mode: "agent"
description: "Weekly engineering retrospective from git"
---
...
## Arguments
- `/sl-retro` — last 7 days (default)
- `/sl-retro 24h` — last 24 hours
- `/sl-retro 14d` — last 14 days
- `/sl-retro 30d` — last 30 days
...
Start the next cycle with `/sl-plan` for the highest-priority item from the retro.
